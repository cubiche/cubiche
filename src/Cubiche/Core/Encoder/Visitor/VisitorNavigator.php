...
namespace Cubiche\Core\Encoder\Visitor;
...
use Cubiche\Core\Encoder\Event\PostDeserializeEvent;
use Cubiche\Core\Encoder\Event\PostSerializeEvent;
use Cubiche\Core\Encoder\Event\PreDeserializeEvent;
use Cubiche\Core\Encoder\Event\PreSerializeEvent;
use Cubiche\Core\Encoder\Exception\SerializationException;
use Cubiche\Core\Encoder\Handler\HandlerManagerInterface;
