...
namespace Cubiche\Infrastructure\Metadata\Tests\Fixtures;
...
use Cubiche\Infrastructure\Metadata\Annotations as Cubiche;
...
class User extends Entity
{
    /**
     * @var IdInterface
     * @Cubiche\Id(type="Cubiche\Infrastructure\Metadata\Tests\Fixtures\UserId")
     */
    protected $id;
     ...
     * @Cubiche\Field(type="ArrayList[Cubiche\Infrastructure\Metadata\Tests\Fixtures\Address]")
     */
    protected $addresses;

    /**
     * @var ArraySetInterface
     * @Cubiche\Field(type="ArraySet[Cubiche\Infrastructure\Metadata\Tests\Fixtures\User]")
     */
    protected $friends;
