...
use Cubiche\Infrastructure\Metadata\Driver\YamlDriver;
    ...
    protected function createDriver()
    {
        ...
        return new YamlDriver(
            new DefaultFileLocator([
                $mappingDirectory => 'Cubiche\Infrastructure\Metadata\Tests\Fixtures',
            ])
        );
    }
        ...
        $this
            ...
            ->then()
                ->exception(function () use ($driver) {
                    $driver->loadMetadataForClass('Cubiche\Infrastructure\Metadata\Tests\Fixtures\Venue');
