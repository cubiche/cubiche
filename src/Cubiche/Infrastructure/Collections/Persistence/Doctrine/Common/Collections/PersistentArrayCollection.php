 ...
 */
class PersistentArrayCollection extends PersistentCollection implements ArrayCollectionInterface
{
    /**
    ...
    {
        return new DataSourceCollection(new IteratorDataSource($this->collection->getIterator(), $criteria));
    }
    ...
    {
        return (new IteratorDataSource($this->collection->getIterator(), $criteria))->findOne();
    }
    ...
    {
        return new DataSourceCollection(new IteratorDataSource($this->collection->getIterator(), null, $criteria));
    }
