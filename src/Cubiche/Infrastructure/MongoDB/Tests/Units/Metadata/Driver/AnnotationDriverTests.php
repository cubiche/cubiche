 ...
 */
class AnnotationDriverTests extends DriverTestCase
{
    /**
     * @var string
     */
    ...
    protected function createDriver()
    {
        ...
        AnnotationRegistry::registerFile(__DIR__.'/../../../../Metadata/Annotations/AggregateRoot.php');
        AnnotationRegistry::registerFile(__DIR__.'/../../../../Metadata/Annotations/Entity.php');
        AnnotationRegistry::registerFile(__DIR__.'/../../../../Metadata/Annotations/Field.php');
        AnnotationRegistry::registerFile(__DIR__.'/../../../../Metadata/Annotations/Id.php');

        $driver = new AnnotationDriver($reader, [__DIR__.'/../../../Fixtures/Metadata']);
        $driver->addExcludePaths([
            __DIR__.'/../../../Fixtures/Metadata/mapping',
        ]);
    ...
    public function testLoadMetadataForClass()
    {
        ...
        $this
            ->given($driver = $this->createDriver())
            ->then()
                ->variable($driver->loadMetadataForClass(AddressId::class))
                    ->isNull()
        ;
    }
